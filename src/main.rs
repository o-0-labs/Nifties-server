...
use crate::controller::common_controller::{unvalid_token, general_not_found, CORS, static_source,upload,error,options,options2};
...
async fn main()  {
    ...
    if let Err(e) = rocket::build()
                    ...
                    .mount("/", routes![query,insert,update,delete,static_source,upload,login,register,error,options,options2,
